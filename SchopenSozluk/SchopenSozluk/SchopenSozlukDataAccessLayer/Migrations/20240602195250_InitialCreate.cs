        ...
        constraints: table =>
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: true)  // UserId nullable yapıldı
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Basliklar", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Basliklar_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Entryler", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Entryler_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Entryler_Basliklar_BaslikId",
                        column: x => x.BaslikId,
                        principalTable: "Basliklar",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Entryler_Entryler_ParentEntryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Dislikes_Entryler_EntryId",
                        column: x => x.EntryId,
                        principalTable: "Entryler",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Likes_Entryler_EntryId",
                        column: x => x.EntryId,
                        principalTable: "Entryler",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Entryler_BaslikId",
                table: "Entryler",
                column: "BaslikId");

            migrationBuilder.CreateIndex(
                name: "IX_Entryler_ParentEntryId",
                table: "Entryler",
                column: "ParentEntryId");

            migrationBuilder.CreateIndex(
                name: "IX_Entryler_UserId",
                table: "Entryler",
                column: "UserId");
